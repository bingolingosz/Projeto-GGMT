...
<head>
    ...
    <title>Sites Publicados</title>
    <link rel="stylesheet" href="css/sitespublicados.css">
...
<body>
    ...
    <div class="filtros">
        ...
        <span>Ordenado por: <strong> Mais populares </strong></span>
    </div>

    <section class="games-container">
        <!-- Cards dos jogos  a short hike-->
        <div class="game-card">
            <a href="sitefeito" class="game-card" target="_blank">
                <img src="htmls/sitesFeitos/dbd/DeadByDaylight.png" alt="a-short-hike">
            </a>
            <h2>Dead by Daylight</h2>
            <p>Feito por: <a href="perfil">Renato</a></p>
        </div>
        <div class="game-card">
            <a href="sitefeito" class="game-card" target="_blank">
                <img src="htmls\sitesFeitos\imagessite\canva.webp" alt="a-short-hike">
            </a>
            <h2>Canva</h2>
            <p>Feito por: <a href="perfil">Elon Musk</a></p>
        </div>
    </section>
